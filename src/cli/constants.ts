...
export const LLM_PROVIDERS = [
  ...
  { id: 'gemini-cli', label: 'Gemini CLI (Google account)', envVar: '', signupUrl: 'https://www.npmjs.com/package/@google/gemini-cli', docsUrl: 'https://github.com/google-gemini/gemini-cli', validationUrl: '', models: ['gemini-2.5-flash', 'gemini-2.5-pro', 'gemini-2.0-flash', 'gemini-2.0-flash-lite'] },
