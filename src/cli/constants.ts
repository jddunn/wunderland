...
export const LLM_PROVIDERS = [
  ...
  { id: 'ollama', label: 'Ollama (local)', envVar: '', signupUrl: 'https://ollama.ai/download', docsUrl: 'https://docs.ollama.com/', validationUrl: '', models: ['llama3', 'llama3.2:3b', 'mistral', 'codellama'] },
