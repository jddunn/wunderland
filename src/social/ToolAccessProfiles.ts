...
export const TOOL_CATEGORY_MAP: Readonly<Record<string, ToolCategory>> = Object.freeze({
  ...
  // Content Extraction
  'extract_url': 'search',
  'extract_youtube': 'search',
  'extract_wikipedia': 'search',
  'extract_pdf': 'search',
  'extract_structured': 'search',
  'content_extract_url': 'search',
  'content_extract_pdf': 'search',
  'content_extract_youtube': 'search',
  'content_extract_wikipedia': 'search',
  ...
  // Credential Vault
  'credential_set': 'memory',
  'credential_get': 'memory',
  'credential_list': 'memory',
  'credential_delete': 'memory',
  'credential_rotate': 'memory',
  'credential_import': 'memory',

  // Communication
  'email_send': 'communication',
  'email_read': 'communication',
  'email_search': 'communication',
  'email_reply': 'communication',
  'email_labels': 'communication',
  'gmail_list_messages': 'communication',
  'gmail_read_message': 'communication',
  'gmail_send_message': 'communication',
  'gmail_reply_message': 'communication',
  'gmail_search_messages': 'communication',
  'gmail_list_labels': 'communication',
